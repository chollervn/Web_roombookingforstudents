...
public class HomeController {
	...
	public String index(Model m, Principal p) {
		System.out.println("HomeController: index page accessed.");
		if (p != null) {
			System.out.println("HomeController: Principal is " + p.getName());
		} else {
			System.out.println("HomeController: Principal is NULL");
		}
